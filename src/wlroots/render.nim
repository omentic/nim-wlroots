...
type WlrRenderer_impl* {.bycopy.} = object
...
type WlrTexture_impl* {.bycopy.} = object
...
proc getCurrentImage*(wlr_renderer: ptr WlrRenderer): ptr pixman_image_t {.importc: "wlr_pixman_renderer_get_current_image".}
...
proc getImage*(wlr_texture: ptr WlrTexture): ptr pixman_image_t {.importc: "wlr_pixman_texture_get_image".}
...
type WlrRenderer_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrRenderer* {.bycopy.} = object
