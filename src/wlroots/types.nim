...
type WlrShmAttributes* {.bycopy.} = object
  fd*: cint
  format*: uint32
  width*, height*: cint
  stride*: cint
...
type WlrBuffer_impl* {.bycopy.} = object
...
type WlrBuffer_events* {.bycopy.} = object
  destroy*: WlSignal
  release*: WlSignal

type WlrBuffer* {.bycopy.} = object
...
proc applyDamage*(client_buffer: ptr WlrClientBuffer; next: ptr WlrBuffer; damage: ptr pixman_region32_t): bool {.importc: "wlr_client_buffer_apply_damage".}
...
type WlrCompositor_events* {.bycopy.} = object
  new_surface*: WlSignal
  destroy*: WlSignal

type WlrCompositor* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrCursor_events* {.bycopy.} = object
  motion*: WlSignal
...
type WlrDataControlManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal
  new_device*: WlSignal

type WlrDataControlManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  devices*: WlList
...
type WlrDataDeviceManager_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrDataDeviceManager* {.bycopy.} = object
  global*: ptr WlGlobal
  data_sources*: WlList
  display_destroy*: WlListener
...
type WlrDataOfferType* = enum
  WLR_DATA_OFFER_SELECTION, WLR_DATA_OFFER_DRAG

type WlrDataOffer* {.bycopy.} = object
  resource*: ptr WlResource
...
type WlrDataSource_impl* {.bycopy.} = object
...
type WlrDataSource_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrDataSource* {.bycopy.} = object
...
type WlrDragIcon_events* {.bycopy.} = object
  map*: WlSignal
  unmap*: WlSignal
  destroy*: WlSignal

type WlrDragIcon* {.bycopy.} = object
  drag*: ptr WlrDrag
...
type WlrDragGrabType* = enum
  WLR_DRAG_GRAB_KEYBOARD,
  WLR_DRAG_GRAB_KEYBOARD_POINTER,
  WLR_DRAG_GRAB_KEYBOARD_TOUCH

type WlrDrag_events* {.bycopy.} = object
  focus*: WlSignal
  motion*: WlSignal
  drop*: WlSignal
  destroy*: WlSignal

type WlrDrag* {.bycopy.} = object
...
type WlrDrmLease_v1_manager_events* {.bycopy.} = object
  request*: WlSignal

type WlrDrmLease_v1_manager* {.bycopy.} = object
  devices*: WlList
  display*: ptr WlDisplay
  display_destroy*: WlListener
  events*: WlrDrmLease_v1_manager_events

type WlrDrmLeaseDevice_v1* {.bycopy.} = object
  resources*: WlList
  global*: ptr WlGlobal
...
type WlrDrmLeaseConnector_v1* {.bycopy.} = object
  resources*: WlList
...
type WlrDrmLeaseRequest_v1* {.bycopy.} = object
  resource*: ptr WlResource
  device*: ptr WlrDrmLeaseDevice_v1
...
type WlrDrmLease_v1* {.bycopy.} = object
  resource*: ptr WlResource
...
type WlrDrm_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrDrm* {.bycopy.} = object
  global*: ptr WlGlobal
  renderer*: ptr WlrRenderer
  node_name*: cstring
...
type WlrExportDmabufManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrExportDmabufManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  frames*: WlList
  display_destroy*: WlListener
...
type WlrForeignToplevelManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrForeignToplevelManager_v1* {.bycopy.} = object
...
type WlrForeignToplevelHandle_v1_events* {.bycopy.} = object
...
type WlrForeignToplevelHandle_v1* {.bycopy.} = object
...
type WlrFullscreenShell_v1_events* {.bycopy.} = object
  destroy*: WlSignal
  present_surface*: WlSignal

type WlrFullscreenShell_v1* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrGammaControlManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrGammaControlManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  controls*: WlList
  display_destroy*: WlListener
...
type WllrIdleInhibitManager_v1_events* {.bycopy.} = object
  new_inhibitor*: WlSignal
  destroy*: WlSignal

type WlrIdleInhibitManager_v1* {.bycopy.} = object
  inhibitors*: WlList
  global*: ptr WlGlobal
  display_destroy*: WlListener
...
type WlrIdleInhibitor_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrIdleInhibitor_v1* {.bycopy.} = object
  surface*: ptr WlrSurface
  resource*: ptr WlResource
  surface_destroy*: WlListener
  link*: WlList
...
proc wlr_idle_inhibit_v1_create*(display: ptr WlDisplay): ptr WlrIdleInhibitManager_v1 {.importc: "wlr_idle_inhibit_v1_create".}

## wlr_idle

type WlrIdle_events* {.bycopy.} = object
  activity_notify*: WlSignal
  destroy*: WlSignal

type WlrIdle* {.bycopy.} = object
  global*: ptr WlGlobal
  idle_timers*: WlList
  event_loop*: ptr WlEventLoop
  enabled*: bool
...
type WlrIdleTimeout* {.bycopy.} = object
  idle*: WlSignal
  resume*: WlSignal
  destroy*: WlSignal
...
type WlrInputDevice_ano* {.bycopy, union.} = object
...
type WlrInputDevice_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrInputDevice* {.bycopy.} = object
...
type WlrInputInhibitManager_events* {.bycopy.} = object
  activate*: WlSignal
  deactivate*: WlSignal
  destroy*: WlSignal

type WlrInputInhibitManager* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrInputMethod_v2_preedit_string* {.bycopy.} = object
  text*: cstring
  cursor_begin*: int32
  cursor_end*: int32

type WlrInputMethod_v2_delete_surrounding_text* {.bycopy.} = object
  before_length*: uint32
  after_length*: uint32

type WlrInputMethod_v2_state* {.bycopy.} = object
  preedit*: WlrInputMethod_v2_preedit_string
  commit_text*: cstring
  delete*: WlrInputMethod_v2_delete_surrounding_text

type WlrInputMethod_v2_events* {.bycopy.} = object
  commit*: WlSignal
  new_popup_surface*: WlSignal
  grab_keyboard*: WlSignal
  destroy*: WlSignal

type WlrInputMethod_v2* {.bycopy.} = object
  resource*: ptr WlResource
  seat*: ptr WlrSeat
  seat_client*: ptr WlrSeatClient
...
type WlrInputPopupSurface_v2_events* {.bycopy.} = object
  map*: WlSignal
  unmap*: WlSignal
  destroy*: WlSignal

type WlrInputPopupSurface_v2* {.bycopy.} = object
  resource*: ptr WlResource
...
type WlrInputMethodKeyboardGrab_v2_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrInputMethodKeyboardGrab_v2* {.bycopy.} = object
  resource*: ptr WlResource
  input_method*: ptr WlrInputMethod_v2
  keyboard*: ptr WlrKeyboard
...
type WlrInputMethodManager_v2_events* {.bycopy.} = object
  input_method*: WlSignal
  destroy*: WlSignal

type WlrInputMethodManager_v2* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrKeyboardGroup_events* {.bycopy.} = object
  enter*: WlSignal
  leave*: WlSignal

type WlrKeyboardGroup* {.bycopy.} = object
...
type WlrKeyboardModifiers* {.bycopy.} = object
  depressed*: xkb_mod_mask_t
  latched*: xkb_mod_mask_t
  locked*: xkb_mod_mask_t
  group*: xkb_mod_mask_t

type WlrKeyboard_repeat_info* {.bycopy.} = object
  rate*: int32
  delay*: int32

type WlrKeyboard_events* {.bycopy.} = object
  key*: WlSignal
  modifiers*: WlSignal
  keymap*: WlSignal
...
type WlrKeyboard* {.bycopy.} = object
...
proc setKeymap*(kb: ptr WlrKeyboard; keymap: ptr xkb_keymap): bool {.importc: "wlr_keyboard_set_keymap".}
proc keymapsMatch*(km1: ptr xkb_keymap; km2: ptr xkb_keymap): bool {.importc: "wlr_keyboard_keymaps_match".}
...
type WlrKeyboardShortcutsInhibitManager_v1_events* {.bycopy.} = object
  new_inhibitor*: WlSignal
  destroy*: WlSignal

type WlrKeyboardShortcutsInhibitManager_v1* {.bycopy.} = object
  inhibitors*: WlList
  global*: ptr WlGlobal
  display_destroy*: WlListener
...
type WlrKeyboardShortcutsInhibitor_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrKeyboardShortcutsInhibitor_v1* {.bycopy.} = object
  surface*: ptr WlrSurface
  seat*: ptr WlrSeat
  active*: bool
  resource*: ptr WlResource
...
type WlrLayerShell_v1_events* {.bycopy.} = object
  new_surface*: WlSignal
  destroy*: WlSignal

type WlrLayerShell_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  display_destroy*: WlListener
...
type WlrLayerSurface_v1_state_margin* {.bycopy.} = object
  top*: uint32
  right*: uint32
  bottom*: uint32
  left*: uint32

type WlrLayerSurface_v1_state* {.bycopy.} = object
  committed*: uint32
  anchor*: uint32
...
type WlrLayerSurface_v1_configure* {.bycopy.} = object
  link*: WlList
  serial*: uint32
  width*, height*: uint32

type WlrLayerSurface_v1_events* {.bycopy.} = object
  destroy*: WlSignal
  map*: WlSignal
  unmap*: WlSignal
  new_popup*: WlSignal

type WlrLayerSurface_v1* {.bycopy.} = object
  surface*: ptr WlrSurface
  output*: ptr WlrOutput
  resource*: ptr WlResource
...
type WlrLinuxDmabufFeedback_v1* {.bycopy.} = object
  main_device*: dev_t
  tranches_len*: csize_t
  tranches*: ptr WlrLinuxDmabufFeedback_v1_tranche

type WlrLinuxDmabufFeedback_v1_tranche* {.bycopy.} = object
  target_device*: dev_t
  flags*: uint32
  formats*: ptr WlrDrmFormatSet

type WlrLinuxDmabuf_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrLinuxDmabuf_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  renderer*: ptr WlrRenderer
...
type WlrOutputDamage_events* {.bycopy.} = object
  frame*: WlSignal
  destroy*: WlSignal

type WlrOutputDamage* {.bycopy.} = object
  output*: ptr WlrOutput
  max_rects*: cint
...
proc attachRender*(output_damage: ptr WlrOutputDamage; needs_frame: ptr bool; buffer_damage: ptr pixman_region32_t): bool {.importc: "wlr_output_damage_attach_render".}
proc add*(output_damage: ptr WlrOutputDamage; damage: ptr pixman_region32_t) {.importc: "wlr_output_damage_add".}
...
type WlrOutputLayout_events* {.bycopy.} = object
  add*: WlSignal
  change*: WlSignal
  destroy*: WlSignal

type WlrOutputLayout* {.bycopy.} = object
  outputs*: WlList
  state*: ptr WlrOutputLayout_state
  events*: WlrOutputLayout_events
  data*: pointer

type WlrOutputLayoutOutput_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrOutputLayoutOutput* {.bycopy.} = object
  output*: ptr WlrOutput
  x*, y*: cint
  link*: WlList
...
type WlrOutputManager_v1_events* {.bycopy.} = object
  apply*: WlSignal
  test*: WlSignal
  destroy*: WlSignal

type WlrOutputManager_v1* {.bycopy.} = object
  display*: ptr WlDisplay
  global*: ptr WlGlobal
  resources*: WlList
  heads*: WlList
...
type WlrOutputHead_v1_state_custom_mode* {.bycopy.} = object
  width*, height*: int32
  refresh*: int32

type WlrOutputHead_v1_state* {.bycopy.} = object
  output*: ptr WlrOutput
  enabled*: bool
...
type WlrOutputHead_v1* {.bycopy.} = object
...
type WlrOutputMode* {.bycopy.} = object
  width*, height*: int32
  refresh*: int32
  preferred*: bool
  link*: WlList

type WlrOutputCursor_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrOutputCursor* {.bycopy.} = object
  output*: ptr WlrOutput
  x*, y*: cdouble
  enabled*: bool
  visible*: bool
...
type WlrOutputStateModeType* = enum
  WLR_OUTPUT_STATE_MODE_FIXED,
  WLR_OUTPUT_STATE_MODE_CUSTOM

type WlrOutputState* {.bycopy.} = object
  width*, height*: int32
  refresh*: int32
...
type WlrOutputState* {.bycopy.} = object
  ...
  mode*: ptr WlrOutput_mode
  custom_mode*: WlrOutputState
  gamma_lut*: ptr uint16
  gamma_lut_size*: csize_t

type WlrOutputEvents* {.bycopy.} = object
  frame*: WlSignal
  damage*: WlSignal
...
proc initRender*(output: ptr WlrOutput; allocator: ptr WlrAllocater; renderer: ptr WlrRenderer): bool {.importc: "wlr_output_init_render".}
...
proc setDamage*(output: ptr WlrOutput; damage: ptr pixman_region32_t) {.importc: "wlr_output_set_damage".}
...
proc renderSoftwareCursors*(output: ptr WlrOutput; damage: ptr pixman_region32_t) {.importc: "wlr_output_render_software_cursors".}
...
type WlrOutputPowerManager_v1_events* {.bycopy.} = object
  set_mode*: WlSignal
  destroy*: WlSignal

type WlrOutputPowerManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrPointerConstraint_v1_state* {.bycopy.} = object
  x*, y*: cdouble

type WlrPointerConstraint_v1_state* {.bycopy.} = object
  committed*: uint32
  region*: pixman_region32_t
  cursor_hint*: WlrPointerConstraint_v1_state

type WlrPointerConstraint_v1_events* {.bycopy.} = object
  set_region*: WlSignal
  destroy*: WlSignal

type WlrPointerConstraint_v1* {.bycopy.} = object
...
type WlrPointerConstraints_v1_events* {.bycopy.} = object
  new_constraint*: WlSignal

type WlrPointerConstraints_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  constraints*: WlList
...
type WlrPointerGestures_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrPointerGestures_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  swipes*: WlList
  pinches*: WlList
  holds*: WlList
...
type WlrPointer_events* {.bycopy.} = object
  motion*: WlSignal
  motion_absolute*: WlSignal
  button*: WlSignal
  axis*: WlSignal
...
type WlrEventPointerButton* {.bycopy.} = object
  device*: ptr WlrInputDevice
  time_msec*: uint32
  button*: uint32
...
type WlrPresentation_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrPresentation* {.bycopy.} = object
  global*: ptr WlGlobal
  clock*: ClockId
...
type WlrPrimarySelectionSource_impl* {.bycopy.} = object
...
type WlrPrimarySelectionSource_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrPrimarySelectionSource* {.bycopy.} = object
...
type WlrPrimarySelection_v1_device_manager_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrPrimarySelection_v1_device_manager* {.bycopy.} = object
  global*: ptr WlGlobal
  devices*: WlList
  display_destroy*: WlListener
...
proc wlrRegion*(resource: ptr WlResource): ptr pixman_region32_t {.importc: "wlr_region_from_resource".}

## XXX: wlr_region??

## wlr_relative_pointer

type WlrRelativePointerManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal
  new_relative_pointer*: WlSignal

type WlrRelativePointerManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrRelativePointer_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrRelativePointer_v1* {.bycopy.} = object
  resource*: ptr WlResource
...
type WlrSceneNode_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrSceneNode* {.bycopy.} = object
...
proc render_output*(scene: ptr WlrScene; output: ptr WlrOutput; lx: cint; ly: cint; damage: ptr pixman_region32_t) {.importc: "wlr_scene_render_output".}
...
proc setTransform*(scene_buffer: ptr WlrSceneBuffer; transform: wl_output_transform) {.importc: "wlr_scene_buffer_set_transform".}
...
type WlrScreencopyManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrScreencopyManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  frames*: WlList
  display_destroy*: WlListener
...
type WlrSeatClient_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrSeatClient* {.bycopy.} = object
  client*: ptr WlClient
  seat*: ptr WlrSeat
  link*: WlList
  resources*: WlList
...
type WlrTouchPoint_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrTouchPoint* {.bycopy.} = object
  touch_id*: int32
  surface*: ptr WlrSurface
...
type WlrPointerGrabInterface* {.bycopy.} = object
...
type WlrKeyboardGrabInterface* {.bycopy.} = object
...
type WlrTouchGrabInterface* {.bycopy.} = object
...
type WlrSeatTouchGrab* {.bycopy.} = object
  `interface`*: ptr WlrTouchGrab_interface
  seat*: ptr WlrSeat
  data*: pointer

type WlrSeatKeyboardGrab* {.bycopy.} = object
  `interface`*: ptr WlrKeyboardGrab_interface
  seat*: ptr WlrSeat
  data*: pointer

type WlrSeatPointerGrab* {.bycopy.} = object
...
type WlrSeatPointerState_events* {.bycopy.} = object
  focus_change*: WlSignal

type WlrSeatPointerState* {.bycopy.} = object
  seat*: ptr WlrSeat
...
type WlrSeatKeyboardState_events* {.bycopy.} = object
  focus_change*: WlSignal

type WlrSeatKeyboardState* {.bycopy.} = object
  seat*: ptr WlrSeat
  keyboard*: ptr WlrKeyboard
  focused_client*: ptr WlrSeatClient
  focused_surface*: ptr WlrSurface
...
type WlrSeatTouchState* {.bycopy.} = object
  seat*: ptr WlrSeat
  touch_points*: WlList
  grab_serial*: uint32
  grab_id*: uint32
...
type WlrSeat_events* {.bycopy.} = object
...
type WlrServerDecorationManager_events* {.bycopy.} = object
  new_decoration*: WlSignal
  destroy*: WlSignal

type WlrServerDecorationManager* {.bycopy.} = object
  global*: ptr WlGlobal
  resources*: WlList
  decorations*: WlList
  default_mode*: uint32
...
type WlrServerDecoration_events* {.bycopy.} = object
  destroy*: WlSignal
  mode*: WlSignal

type WlrServerDecoration* {.bycopy.} = object
  resource*: ptr WlResource
  surface*: ptr WlrSurface
  link*: WlList
  mode*: uint32
...
type WlrSurfaceStateViewport* {.bycopy.} = object
  has_src*: bool
  has_dst*: bool
  src*: WlrFbox
  dst_width*, dst_height*: cint

type WlrSurfaceState* {.bycopy.} = object
  committed*: uint32
  seq*: uint32
  buffer*: ptr WlrBuffer
  dx*, dy*: int32
...
type WlrSurfaceRole* {.bycopy.} = object
  name*: cstring
...
type WlrSurface_events* {.bycopy.} = object
  commit*: WlSignal
  new_subsurface*: WlSignal
  destroy*: WlSignal

type WlrSurface_previous* {.bycopy.} = object
  scale*: int32
  transform*: WlOutputTransform
  width*, height*: cint
  buffer_width*, buffer_height*: cint

type WlrSurface* {.bycopy.} = object
  resource*: ptr WlResource
  renderer*: ptr WlrRenderer
...
type WlrSubsurfaceParentState* {.bycopy.} = object
  x*, y*: int32
  link*: WlList

type WlrSubsurface_events* {.bycopy.} = object
  destroy*: WlSignal
  map*: WlSignal
  unmap*: WlSignal

type WlrSubsurface* {.bycopy.} = object
  resource*: ptr WlResource
  surface*: ptr WlrSurface
...
proc getEffectiveDamage*(surface: ptr WlrSurface; damage: ptr pixman_region32_t) {.importc: "wlr_surface_get_effective_damage".}
...
type WlrSwitch_events* {.bycopy.} = object
  toggle*: WlSignal

type WlrSwitch* {.bycopy.} = object
...
type WlrEventSwitchToggle* {.bycopy.} = object
  device*: ptr WlrInputDevice
  time_msec*: uint32
...
type WlrTabletPad_events* {.bycopy.} = object
  button*: WlSignal
  ring*: WlSignal
  strip*: WlSignal
  attach_tablet*: WlSignal

type WlrTabletPad* {.bycopy.} = object
...
type WlrEventTabletPadButton* {.bycopy.} = object
  time_msec*: uint32
  button*: uint32
  state*: WlrButtonState
  mode*: cuint
...
type WlrTabletTool_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrTabletTool* {.bycopy.} = object
...
type WlrTablet_events* {.bycopy.} = object
  axis*: WlSignal
  proximity*: WlSignal
  tip*: WlSignal
  button*: WlSignal

type WlrTablet* {.bycopy.} = object
...
type WlrEventTabletToolAxis* {.bycopy.} = object
  device*: ptr WlrInputDevice
...
type WlrEventTabletToolProximity* {.bycopy.} = object
  device*: ptr WlrInputDevice
  tool*: ptr WlrTabletTool
  time_msec*: uint32
  x*, y*: cdouble
...
type WlrTabletToolTipState* = enum
  WLR_TABLET_TOOL_TIP_UP, WLR_TABLET_TOOL_TIP_DOWN

type WlrEventTabletToolTip* {.bycopy.} = object
  device*: ptr WlrInputDevice
  tool*: ptr WlrTabletTool
  time_msec*: uint32
  x*, y*: cdouble
...
type WlrEventTabletToolButton* {.bycopy.} = object
  device*: ptr WlrInputDevice
  tool*: ptr WlrTabletTool
  time_msec*: uint32
  button*: uint32
...
type WlrTabletPad_v2_grab* {.bycopy.} = object
  `interface`*: ptr WlrTabletPad_v2_grab_interface
  pad*: ptr WlrTablet_v2_tablet_pad
  data*: pointer

type WlrTabletTool_v2_grab* {.bycopy.} = object
  `interface`*: ptr WlrTabletTool_v2_grab_interface
  tool*: ptr WlrTablet_v2_tablet_tool
  data*: pointer

type WlrTabletManager_v2_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrTabletManager_v2* {.bycopy.} = object
...
type WlrTablet_v2_tablet_tool* {.bycopy.} = object
  set_cursor*: WlSignal
...
type WlrTablet_v2_tablet_tool* {.bycopy.} = object
  ...
  events*: WlrTablet_v2_tablet_tool

type WlrTablet_v2_tablet_pad_events* {.bycopy.} = object
  button_feedback*: WlSignal
  strip_feedback*: WlSignal
  ring_feedback*: WlSignal

type WlrTablet_v2_tablet_pad* {.bycopy.} = object
  link*: WlList
...
type WlrTabletTool_v2_grab_interface* {.bycopy.} = object
...
type WlrTabletPad_v2_grab_interface* {.bycopy.} = object
...
type WlrTextInput_v3_surrounding* {.bycopy.} = object
  text*: cstring
  cursor*: uint32
  anchor*: uint32

type WlrTextInput_v3_state_content_type* {.bycopy.} = object
  hint*: uint32
  purpose*: uint32

type WlrTextInput_v3_state* {.bycopy.} = object
...
type WlrTextInput_v3_events* {.bycopy.} = object
  enable*: WlSignal
  commit*: WlSignal
  disable*: WlSignal
  destroy*: WlSignal

type WlrTextInput_v3* {.bycopy.} = object
  seat*: ptr WlrSeat
  resource*: ptr WlResource
  focused_surface*: ptr WlrSurface
...
type WlrTextInputManager_v3_events* {.bycopy.} = object
  text_input*: WlSignal
  destroy*: WlSignal

type WlrTextInputManager_v3* {.bycopy.} = object
  global*: ptr WlGlobal
  text_inputs*: WlList
  display_destroy*: WlListener
...
type WlrTouch_events* {.bycopy.} = object
  down*: WlSignal
  up*: WlSignal
  motion*: WlSignal
  cancel*: WlSignal
...
type WlrTouch* {.bycopy.} = object
  `impl`: ptr WlrTouch_impl
  events: WlrTouch_events
  data*: pointer

type WlrEventTouchDown* {.bycopy.} = object
  device*: ptr WlrInputDevice
  time_msec*: uint32
  touch_id*: int32
  x*, y*: cdouble

type WlrEventTouchUp* {.bycopy.} = object
  device*: ptr WlrInputDevice
  time_msec*: uint32
  touch_id*: int32

type WlrEventTouchMotion* {.bycopy.} = object
  device*: ptr WlrInputDevice
  time_msec*: uint32
  touch_id*: int32
  x*, y*: cdouble

type WlrEventTouchCancel* {.bycopy.} = object
  device*: ptr WlrInputDevice
  time_msec*: uint32
  touch_id*: int32
...
type WlrViewporter_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrViewporter* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrVirtualKeyboardManager_v1_events* {.bycopy.} = object
  new_virtual_keyboard*: WlSignal
  destroy*: WlSignal

type WlrVirtualKeyboardManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  virtual_keyboards*: WlList
  display_destroy*: WlListener
  events*: WlrVirtualKeyboardManager_v1_events

type WlrVirtualKeyboard_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrVirtualKeyboard_v1* {.bycopy.} = object
...
type WlrVirtualPointerManager_v1_events* {.bycopy.} = object
  new_virtual_pointer*: WlSignal
  destroy*: WlSignal

type WlrVirtualPointerManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  virtual_pointers*: WlList
  display_destroy*: WlListener
  events*: WlrVirtualPointerManager_v1_events

type WlrVirtualPointer_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrVirtualPointer_v1* {.bycopy.} = object
  input_device*: WlrInputDevice
  resource*: ptr WlResource
...
type WlrXdgActivationToken_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrXdgActivationToken_v1* {.bycopy.} = object
...
type WlrXdgActivation_v1_events* {.bycopy.} = object
  destroy*: WlSignal
  request_activate*: WlSignal

type WlrXdgActivation_v1* {.bycopy.} = object
...
type WlrXdgDecorationManager_v1_events* {.bycopy.} = object
  new_toplevel_decoration*: WlSignal
  destroy*: WlSignal

type WlrXdgDecorationManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
  decorations*: WlList
  display_destroy*: WlListener
...
type WlrXdgToplevelDecoration_v1_configure* {.bycopy.} = object
  link*: WlList
  surface_configure*: ptr WlrXdgSurfaceConfigure
  mode*: WlrXdgToplevelDecoration_v1_mode

type WlrXdgToplevelDecoration_v1_state* {.bycopy.} = object
  mode*: WlrXdgToplevelDecoration_v1_mode

type WlrXdgToplevelDecoration_v1_events* {.bycopy.} = object
  destroy*: WlSignal
  request_mode*: WlSignal

type WlrXdgToplevelDecoration_v1* {.bycopy.} = object
  resource*: ptr WlResource
...
type WlrXdgForeignRegistry_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrXdgForeignRegistry* {.bycopy.} = object
  exported_surfaces*: WlList
  display_destroy*: WlListener
  events*: WlrXdgForeignRegistry_events

type WlrXdgForeignExported_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrXdgForeignExported* {.bycopy.} = object
  link*: WlList
...
type WlrXdgForeign_v1_porter* {.bycopy.} = object
  global*: ptr WlGlobal
  objects*: WlList

type WlrXdgForeign_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrXdgForeign_v1* {.bycopy.} = object
...
type WlrXdgForeign_v2_porter* {.bycopy.} = object
  global*: ptr WlGlobal
  objects*: WlList

type WlrXdgForeign_v2_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrXdgForeign_v2* {.bycopy.} = object
...
type WlrXdgOutput_v1* {.bycopy.} = object
...
type WlrXdgOutputManager_v1_events* {.bycopy.} = object
  destroy*: WlSignal

type WlrXdgOutputManager_v1* {.bycopy.} = object
  global*: ptr WlGlobal
...
type WlrXdgShell_events* {.bycopy.} = object
  new_surface*: WlSignal
  destroy*: WlSignal

type WlrXdgShell* {.bycopy.} = object
  global*: ptr WlGlobal
  clients*: WlList
  popup_grabs*: WlList
  ping_timeout*: uint32
...
type WlrXdgClient* {.bycopy.} = object
...
type WlrXdgPositioner_size* {.bycopy.} = object
  width*, height*: int32

type WlrXdgPositioner_offset* {.bycopy.} = object
  x*, y*: int32

type WlrXdgPositioner* {.bycopy.} = object
  anchor_rect*: WlrBox
...
type WlrXdgPopup* {.bycopy.} = object
...
type WlrXdgPopupGrab* {.bycopy.} = object
  client*: ptr WlClient
  pointer_grab*: WlrSeatPointerGrab
  keyboard_grab*: WlrSeatKeyboardGrab
  touch_grab*: WlrSeatTouchGrab
...
type WlrXdgToplevelState* {.bycopy.} = object
  maximized*: bool
  fullscreen*: bool
  resizing*: bool
  activated*: bool
...
type WlrXdgToplevelConfigure* {.bycopy.} = object
  maximized*: bool
  fullscreen*: bool
  resizing*: bool
  activated*: bool
...
type WlrXdgToplevelRequested* {.bycopy.} = object
  maximized*: bool
  minimized*: bool
  fullscreen*: bool
...
type WlrXdgToplevel_events* {.bycopy.} = object
  request_maximize*: WlSignal
  request_fullscreen*: WlSignal
  request_minimize*: WlSignal
...
type WlrXdgToplevel* {.bycopy.} = object
  resource*: ptr WlResource
  base*: ptr WlrXdgSurface
  added*: bool
  ...
  scheduled*: WlrXdgoplevelConfigure
  requested*: WlrXdgToplevelRequested
  title*: cstring
  app_id*: cstring
  events*: WlrXdgToplevel_events

type WlrXdgSurfaceConfigure* {.bycopy.} = object
  surface*: ptr WlrXdgSurface
  link*: WlList
  serial*: uint32
  toplevel_configure*: ptr WlrXdgToplevelConfigure

type WlrXdgSurfaceState* {.bycopy.} = object
  configure_serial*: uint32
  geometry*: WlrBox

type WlrXdgSurface_ano* {.bycopy, union.} = object
  toplevel*: ptr WlrXdgToplevel
  popup*: ptr WlrXdgPopup

type WlrXdgSurface_events* {.bycopy.} = object
  destroy*: WlSignal
...
type WlrXdgSurface* {.bycopy.} = object
